...
export default function FormText(){
    ...
    const onBlurPassword2 = () =>{
        if ( this.textPswd.current.value != this.textPswd2.current.value) {
    ...
    style={{ width:'400px',background:'#cee'}}>
        <form>
            <div className="form-group mb-2">
                ...
                <input type="login" id="login" name="login" maxLength="20"
            ...
            <div className="form-group mb-2">
                <label htmlFor="pswd2">ใส่รหัสผ่าน</label>
            ...
            <div className="form-group mb-2">
                ...
                <textarea id="memo" name="memo" rows="2" maxLength="200" className="form-control form-style-sm">
                </textarea>
